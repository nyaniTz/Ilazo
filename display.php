...
<button style="color:white;border-style:none;background-color:white; cursor:pointer;">
  ...
  <img src="image/Add.png" width="28px" height="25px;"  id="add">
    ...
    <button style="color:white;border-style:none;background-color:white; cursor:pointer;margin-right: 45%">
  <a  onclick="openModal()"  style="text-decoration:none;">
...
<?php  date_default_timezone_set('Africa/nairobi'); 
      ...
      <br/>
        ...
        <div class="mb-44" style="line-height: 26px;white-space: nowrap;max-width: 700px; margin: 0 auto; display: flex;flex-direction: row; justify-content: space-between; ">
    <label style="font-size: 18px;  display: block;font-weight:bold "> Vendor Name </label>
    <input type="text" style="margin-left: 10px;padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 5px; font-size: 16px; transition: border-color 0.3s;" id="Unit" name="VendorName" autocomplete="off" placeholder="Vendor Name" aria-describedby="emailHelp" required
    onfocus="this.style.borderColor='#007bff';"
    onblur="this.style.borderColor='#ccc';">
</div>
<br>

<div class="mb-44" style="line-height: 26px;white-space: nowrap;max-width: 500px; margin: 0 auto; display: flex;flex-direction: row; justify-content: space-between; ">
          <label  style="font-size: 18px;  display: block;font-weight:bold ">Description</label>
          
          <input type="text" style="margin-left: 10px;padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 5px; font-size: 16px; transition: border-color 0.3s;" class="form-control" id="Description" name="Description" value="<?php if(isset($_POST['barkod'])){
...
<a href="barcode.php" style="margin-left:14px;"><img  id="scan" src="image/scan.png"  alt="Scanning" /></a>
