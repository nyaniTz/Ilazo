...
<br><br><br>
<form action="orderdetals.php" method="POST">
  <button id="like1" name="neworder"  style="background-color:#343a40;color:white;cursor:pointer">New Order</button>

  <input type="hidden" name="newordetext" value="">
