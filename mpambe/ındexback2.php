...
if (mysqli_num_rows($result) > 0) {
 ...
 <td ><?php echo $sn; ?> </td>
  ...
  <form action="refresher.php" method="POST">
   ...
   <input type="text" name="PurchasedQuantity" value="<?php echo $data['PurchasingQty']; ?>">
...
-->
<button class="button2 button2" style="margin-left:48%;" name="print" value="<?php echo $oldget; ?>" onclick="myFunction1();">Print</button>
</form>
</td>
